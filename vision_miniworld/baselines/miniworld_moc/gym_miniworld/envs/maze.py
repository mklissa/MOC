...
class Maze(MiniWorldEnv):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            max_episode_steps = max_episode_steps or num_rows * num_cols * 30,
            **kwargs
        )
    ...
    def _gen_world(self):
        ...
        self.box = self.place_entity(Box(color='red'),room=self.rooms[0])

        self.place_agent(room=self.rooms[-1])
...
class MazeS2Fixed(Maze):
    def __init__(self):
        super().__init__(num_rows=2, num_cols=2)

class MazeS2Plus(Maze):
    def __init__(self):
        super().__init__(num_rows=2, num_cols=3)
